...
public class MouseHandler implements MouseInputListener {
    ...
    public final static int ZOOMFACTOR = 10;

    // width and height of rectangle for zooming
    // a higher divisor will cause a more agressive zoom
    final static int WIDTH = (int) (MandelbrotCore.WIDTH / ZOOMFACTOR);
    final static int HEIGHT = (int) (MandelbrotCore.HEIGHT / ZOOMFACTOR);
